    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <form @submit.prevent="submit" class="mt-6 space-y-6">
            <div class="tabs flex space-x-8 mb-4">
                ...
                <a @click="currentMainTab = 'about_us'"
                   :class="{ active: currentMainTab==='reasons','text-red-600':form.errors.about_us_text}"
                   class="tab-button border-1 border-gray-400 shadow p-2 text-lg hover:text-gray-600 rounded cursor-pointer">
                    Блок "Коротко про нас"
                </a>
                    ...
                    <div style="width: 20%">
                        <div class="relative max-w-[250px]">
                            ...
                            <div class="w-full overflow-hidden rounded-md border border-gray-300"
                                ...
                                <img
                                    :src="form.first_main_image.length<=100 && form.first_main_image!=='/storage/no_image.webp'?
                                    '/storage/our_team/'+form.first_main_image:form.first_main_image"
