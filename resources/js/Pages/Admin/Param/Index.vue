...
const headers = ["Назва", "Значення", "Дії"];
...
<template>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <div class="flex items-center justify-between mb-4">
            <Link :href="itemName+'/create'">
                <Button size="sm" variant="primary" :type="'submit'">+Створити</Button>
            </Link>
                ...
                <tr v-for="(item,index) in items.data" :key="item.id">
                    ...
                    <td class="text-right">
                        <Link :href="`${itemName}/${item.id}/edit`" class="mr-2">
                            <PrimaryButton><i class="fas fa-pencil"></i></PrimaryButton>
                        </Link>
